...
**Deni Leocadio - Technology Leader** **Liderança de Projeto:** Gerente de projetos (Project Management certificado PMP®)

* **Substituição Técnica:** Modernização completa de ferramenta de integração devido a limitações de versão antiga
* **Dupla Responsabilidade:** Project Manager e Application Manager simultaneamente
* **Competências Aplicadas:** IT Service Management, Team Leadership
* **Metodologias:** ITIL, PMBoK, implementação de melhores práticas**Documento preparado para petição EB-2 National Interest Waiver**
...
* **Desenvolvimento Backend:** .NET, C#, Java, Go Lang, Python
* **Cloud Computing:** Azure, AWS Cloud Practitioner, Google Cloud Platform, Digital Ocean
* **DevOps & Containerização:** Docker, Kubernetes
* **Banco de Dados:** Microsoft SQL Server, MySQL, PostgreSQL, Oracle
* **Frontend:** Angular, TypeScript, JavaScript, HTML, CSS
* **Metodologias:** Agile (Scrum), ITIL, PMBoK, Six Sigma
* **Arquitetura:** Microservices, Distributed Systems, Solution Architecture, Enterprise Architecture
* **Integração:** REST APIs, ESB Architecture, MuleSoft, RabbitMQ, Talend
* **Ferramentas:** Git, SharePoint, MS Reporting Services
* **Gestão:** Project Management, IT Service Management, Team Leadership
...
* **Competências Validadas:** IT Service Management, Integration Development, Web Services
* **Banco de Dados:** Microsoft SQL Server para gestão de dados críticos de integração
...
* **Competências Aplicadas:** IT Service Management, Team Leadership
* **Metodologias:** ITIL, PMBoK, implementação de melhores práticas
...
* **Stack Tecnológico Avançado:**
  * **Backend:** ASP.NET Core, C#, REST APIs, Microservices architecture
  * **Frontend:** Angular, TypeScript, JavaScript, HTML, CSS responsivo
  ...
  * **Qualidade de Software:** Unit Testing, Software Quality Assurance
  * **Arquitetura:** Software Architecture, System Architecture
...
* **PARTNER PORTAL - PLM/PIM Global System (2010-2018):** Sistema global de gestão de ciclo de vida de produtos (PLM) e gerenciamento de informações de produtos (PIM)
  ...
  * **Competências Aplicadas:** IT Service Management, Team Leadership
  * **Stack Tecnológico:** Java, .NET Framework, Microsoft SQL Server
  * **Portal Web:** Desenvolvimento com SharePoint para interface de parceiros
...
* **Competências Aplicadas:** Business Intelligence, MS Reporting Services
* **Stack Microsoft BI:** Microsoft SQL Server, SSIS, SSRS, SSAS
* **Portais BI:** SharePoint para dashboards executivos
...
* **Áreas Impactadas:** Melhoria de processos de manufatura, testes, produção, logística e toda cadeia produtiva
...
* **Stack Técnico:** Enterprise Service Bus Architecture, Workflow Automation
...
* **Stack Tecnológico:** VB.NET/C#, Microsoft SQL Server, Oracle, MySQL
* **Systems Analysis:** Aplicação de competências em Systems Analysis
* **Informações Gerenciais:** Volume de produção, capacidade produtiva, visão de estoque, confirmação de ordens
* **Business Analysis:** Aplicação de Business Analysis para requisitos gerenciais
...
* **Software Quality Assurance:** Aplicação de competências em SQA
* **Unit Testing:** Implementação de Unit Testing para garantia de qualidade
...
* **Stack Tecnológico:** VB.NET/C# para desenvolvimento da interface visual
...
* **Software Quality Assurance:** Aplicação de SQA para detecção de falhas
...
* **Fundamentos da Arquitetura de Software** (Full Cycle) - ID: 42e42072-415f-4102-9626-f84f2b344dcd (2022)
